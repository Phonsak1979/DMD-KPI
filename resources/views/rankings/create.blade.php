...
@section('title', 'เพิ่มตัวชี้วัด (KPI)')
            ...
            <div class="col-md-10">
                ...
                <div class="card card-success">
                    <div class="card-header d-flex">
                        <h3 class="card-title"><i class="fas fa-list"></i> เพิ่มตัวชี้วัด (KPI)</h3>
                    </div>
...
บริการฟอกไตฟรี">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="url" class="form-control" id="url"
                                    placeholder="URL ชื่อตาราง เช่น s_kpi_anc12 ">
                                @error('url')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('rankings.index') }}" class="btn btn-warning"><i class="fas fa-undo-alt"></i>
                                กลับ</a>
                        </div>
                    </form>
                </div>
